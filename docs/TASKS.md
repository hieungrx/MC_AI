...
- [ ] **TS02-01**: Khảo sát và lựa chọn mô hình Lip Sync (Wav2Lip vs LivePortrait/SadTalker).
- [ ] **TS02-02**: Cài đặt các thư viện Deep Learning (PyTorch, OpenCV, v.v.) vào `.venv`.
- [ ] **TS02-03**: Tải checkpoint/trọng số của mô hình Lip Sync đã chọn.
- [ ] **TS02-04**: Viết module xử lý hình ảnh & sinh video `src/avatar/lip_sync.py`.
- [ ] **TS02-05**: Viết script chạy thử nghiệm `scripts/test_avatar.py` tạo `hello_avatar.mp4`.
- [ ] **TS02-06**: Tối ưu hóa thời gian xử lý render video.
