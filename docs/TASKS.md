...
## 🎯 Việc Cần Làm Ngay (To-Do) - Sprint 01

- [ ] **TS01-01**: Khảo sát và lựa chọn thư viện/API TTS (Ưu tiên Edge-TTS hoặc Google Cloud TTS).
- [ ] **TS01-02**: Cài đặt các thư viện Python bổ trợ cho âm thanh và TTS vào `.venv`.
- [ ] **TS01-03**: Viết module sinh giọng đọc `src/voice/tts.py` hỗ trợ cấu hình giọng đọc, tốc độ, cao độ.
- [ ] **TS01-04**: Viết script chạy thử nghiệm `scripts/test_tts.py` để sinh ra file `hello.mp3`.
- [ ] **TS01-05**: Thiết lập cấu hình chuyên biệt cho TTS trong `configs/default.yaml`.
- [ ] **TS01-06**: Nghiên cứu và hiện thực phương án phát luồng âm thanh (audio streaming) dạng chunks.
